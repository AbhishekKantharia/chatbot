...
for model in models:
    print(model.name)  # 🔍 Check the available models
...
if st.sidebar.button("🎨 Generate Image"):
    if image_prompt:
        vision_model = genai.GenerativeModel("gemini-1.5-pro-vision")  # If supported
        image_prompt = "Describe an image of a futuristic city."
        response = vision_model.generate_content(image_prompt)
        print(response.text)  # ✅ AI-generated description
